                ...
                <tbody>
                {
                    ...
                    controller.pit.map( ( item, index ) => {
                        return <tr key = { index }
                            ...
                            <td className = { `px-3 py-4 text-center whitespace-nowrap min-w-[60px]` }>{ item.name
                            }</td>
                            <td className = { `px-3 py-4 text-center whitespace-nowrap min-w-[60px]` }>{ item.dealerId
                            }</td>
                            <td className = { `px-3 py-4 text-center whitespace-nowrap min-w-[60px]` }>{ item.address
                            }</td>
                            <td
