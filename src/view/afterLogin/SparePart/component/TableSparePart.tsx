            ...
            <tbody>
            {
                dataTable.map( ( item, index ) => {
                    return <tr key = { index }
                        ...
                        <td className = { `px-3 py-4 text-center whitespace-nowrap min-w-[60px]` }>{ index + 1 + start }</td>
                        <td className = { `px-3 py-4 text-center whitespace-nowrap min-w-[60px]` }>{ item.code }</td>
                        <td className = { `px-3 py-4 text-center whitespace-nowrap min-w-[60px]` }>{ item.name }</td>
                        <td className = { `px-3 py-4 text-center whitespace-nowrap min-w-[60px]` }>{ item.group }</td>
                        <td className = { `px-3 py-4 text-center whitespace-nowrap min-w-[60px]` }>{ item.price }</td>
                        <td className = { `px-3 py-4 text-center whitespace-nowrap min-w-[60px]` }>{ item.priceNasional }</td>
