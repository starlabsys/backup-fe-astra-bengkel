		...
		<div className={`flex-1 grid gap-5`}>
			...
			<div className={`w-full bg-white rounded-lg grid gap-5 relative`}>
				...
				<div className={`p-5 grid gap-5`}>
					<ITablePit
						page={search.search === "" ? getDataPit.setPage : search.setPage}
						totalPage={
							search.search === "" ? getDataPit.totalPage : search.totalPage
						}
						totalRow={
							search.search === "" ? getDataPit.totalRow : search.totalRow
						}
						controller={
							search.search === ""
								? {
