...
import EditKendaraanViewModel from "../EditKendaraan/EditKendaraanViewModel";
    ...
    function stnk() {
        return <div className = { `bg-white rounded-lg p-5 grid gap-5` }>
            ...
            <div className = { `grid tablet:grid-cols-2 gap-5` }>
                ...
                <IRadioSingle status = { controller.status } disabled = { true } setStatus = { () => {
...
export default InfoKendaraanView
